    ...
    def calculate_all_charges(
        ...
        try:
            ...
            result = {
                ...
                'clearing_charge': self._round_to_2decimals(clearing_charge),                'ipft_charge': Decimal('0'),  # IPFT = Investments & Profits Fund Tax (rarely applied)                'gst_charge': self._round_to_2decimals(gst_charge),
